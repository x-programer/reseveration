 ...
 * 
 * XDoclet definition:
 * @struts:action path="/ViewMaila" name="sf" scope="request" validate="true"
 * @struts:action-forward name="suc" path="/viewagentm.jsp"
 */
public class ViewMailActionA extends Action {
	...
	public ActionForward execute(
		...
		HttpServletResponse response) throws Exception{
		 ...
		 HttpSession hs=request.getSession();
			String name=(String)hs.getAttribute("froma");
