 ...
 * 
 * XDoclet definition:
 * @struts:action path="sendMailCAd" name="sf" scope="request" validate="true"
 * @struts:action-forward name="suc" path="/sucmad.jsp"
 */
public class SendMailActionCAd extends Action {
