 ...
 * 
 * XDoclet definition:
 * @struts:action path="/delMaila" name="sf" scope="request" validate="true"
 * @struts:action-forward name="suc" path="/sucagdm.jsp"
 */
public class DelMailActionA extends Action {
