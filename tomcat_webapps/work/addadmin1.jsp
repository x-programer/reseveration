...
<html> 
	...
	<body>
		<html:form action="AddAdmin">
		<center><b><font color="#FF9900" size="5">Add New Admin</font></b><br><br>
		<table>
		  ...
		  <tr>  <td><bean:message key="afname" />:</td><td> <html:text property="afname"/></td><td><html:errors property="afname"/></td></tr>
		    ...
		    <tr><td><bean:message key="pass" /> : </td><td><html:password property="pass"/></td><td><html:errors property="apass"/></td></tr>
